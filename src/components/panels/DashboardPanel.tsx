...
import { SchoolYearCalendar } from '@/components/dashboard/SchoolYearCalendar';
...
export function DashboardPanel() {
  const { state, interactWithStudent, resolveEvent, checkForRandomEvents, advanceDay } = useGame();
